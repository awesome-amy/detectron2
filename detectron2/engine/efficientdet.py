...
class DefaultPredictor:
    ...
    def __init__(self, cfg):
        ...
        # TODO: to use efficientnet backbone, this must be replaced
        #  by the Resizer in efficientdet/dataset.py. For example,
        #  by define a new class ResizeWithPadding(Augmentation)

        # TODO: for a first step, try force resize to 512x512
        self.aug = T.Resize(512)
